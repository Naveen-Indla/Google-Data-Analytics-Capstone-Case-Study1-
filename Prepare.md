...
3. Credibility of the data
    ...
    - Current: This data is up to date. But we only focus on FY 2025 to have a yearly overview. The data can be extended to dec 2023.
    - Cited: The data from Google Analytics Capstone and located at Amazon AWS.

4. Data Organization

    - There are 12 files for 2025 with naming YYYYMM-divvy-tripdata 
## **Trip Data**
